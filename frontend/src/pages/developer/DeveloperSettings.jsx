...
import { Save, Lock, Tags, AlertOctagon, X, Key, ChevronRight } from "lucide-react";
...
export default function DeveloperSettings() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto pb-12 flex flex-col gap-8">
      ...
      {/* API Key Auth Link */}
      <button
        onClick={() => navigate("/developer/portal/keys")}
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
        ...
        <form onSubmit={handlePasswordSave} className="flex flex-col gap-5 max-w-lg">
          ...
          <button type="submit" className="w-fit border-2 border-charcoal text-charcoal px-6 py-2.5 rounded-xl font-bold hover:bg-gray-100 transition-colors">Update Password</button>
        </form>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
        ...
        <div className="max-w-xl">
           ...
           <form onSubmit={addDomain} className="flex gap-3">
              ...
              <button type="submit" className="border-2 border-gray-200 text-gray-600 px-5 py-2.5 rounded-xl font-bold hover:bg-gray-50 transition-colors">Add Server</button>
           </form>
        </div>
      </div>
