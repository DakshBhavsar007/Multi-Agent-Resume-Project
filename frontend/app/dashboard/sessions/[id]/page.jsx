...
import { Upload, Archive, Mail, Link as LinkIcon, Download, Zap, Settings, RefreshCw, X, ChevronDown, Check } from 'lucide-react';
...
export default function SessionWorkspace() {
  ...
  const handleMatchAll = async () => {
    try {
      toast.info("Matching all candidates...");
        ...
        <div className="flex gap-8 mt-4">
          {[
            ...
            <button
              ...
              className={`pb-3 pt-2 text-[15px] font-bold transition-colors border-b-[3px] relative top-[2px] ${
              ...
              <div className="flex-1 overflow-y-auto min-h-[300px] custom-scrollbar pr-2">
                {candidatesList.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center p-12 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 h-[300px] text-center mt-2">
                    <span className="text-5xl mb-5 grayscale opacity-50">🕵️‍♀️</span>
