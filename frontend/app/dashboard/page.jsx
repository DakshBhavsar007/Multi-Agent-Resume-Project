...
import { Layers, Users, Target, Activity } from 'lucide-react';
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center p-16 bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.08)] border border-gray-100 min-h-[400px]">
          ...
          <Link href="/dashboard/sessions/new" className="bg-accent hover:bg-accent-dark text-white px-6 py-3 rounded-lg font-semibold transition-colors shadow">
            Create Session
          </Link>
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.08)] flex flex-col">
          ...
          <Link href="/dashboard/sessions" className="text-accent font-medium text-sm text-center mt-4 pt-4 border-t border-gray-100 hover:text-accent-dark transition-colors inline-block">
