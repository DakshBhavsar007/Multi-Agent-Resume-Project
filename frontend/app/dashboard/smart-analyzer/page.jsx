...
import { Upload, FileText, Check, Zap, BarChart3, Users, Brain, Sparkles, ArrowRight, X, MapPin, Mail, Briefcase, CheckCircle, XCircle, ChevronDown, Trophy, Star, Award } from 'lucide-react';
...
export default function SmartAnalyzer() {
  ...
  const handleAnalysis = async () => {
    ...
    try {
      ...
      headers["Content-Type"] = "application/json";
      try {
        await fetch(`${BASE}/sessions/${sessionId}/infer-skills`, {
      ...
      if (candData.success) {
        const candidates = candData.data?.candidates || candData.data || [];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              >
                <h2 className="text-lg font-black text-[#2A2A2A] flex items-center gap-2.5 mb-5">
                  <div className="w-8 h-8 rounded-lg bg-accent/10 flex items-center justify-center"><Users size={16} className="text-accent" /></div>
                  Candidate Resumes
                </h2>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 mt-1 text-xs text-gray-500 font-medium">
                          ...
                          {cand.experience_years > 0 && <span>💼 {cand.experience_years} yrs</span>}
                        </div>
                      </div>
                        ...
                        >
                          <div className="px-5 pb-5 pt-2 border-t border-gray-100 space-y-5">
                            ...
                            <div className="flex flex-wrap gap-4 text-xs text-gray-500 font-medium">
                              ...
                              {cand.phone && <span className="flex items-center gap-1.5">📞 {cand.phone}</span>}
                            </div>
